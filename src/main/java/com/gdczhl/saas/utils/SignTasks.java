...
public class SignTasks {
     ...
     * @return
     */
    public static String getTaskNameResult(String name, String taskName, LocalTime taskStartTime, LocalTime taskEndTime,
                                     DateTimeFormatter dateTimeFormatter) {
        if (Objects.nonNull(dateTimeFormatter)){
            TimeUtil.setLocalTimeUtil(dateTimeFormatter);
        }
        String startTime = TimeUtil.format(taskStartTime);
        String endTime = TimeUtil.format(taskEndTime);
        StringBuilder builder = new StringBuilder();
        return builder.append(name).append("(").append(taskName).append("(").append(startTime).append("-").append(endTime).append(")").append(")").toString();
    }
